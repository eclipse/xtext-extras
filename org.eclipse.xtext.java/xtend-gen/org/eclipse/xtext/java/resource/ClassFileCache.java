...
public class ClassFileCache {
  ...
  private final Map<QualifiedName, NameEnvironmentAnswer> cache = new WeakHashMap<QualifiedName, NameEnvironmentAnswer>();
  
  public boolean containsKey(final QualifiedName qualifiedName) {
    return this.cache.containsKey(qualifiedName);
  }
  
  public NameEnvironmentAnswer get(final QualifiedName qualifiedName) {
    return this.cache.get(qualifiedName);
  }
  
  public void put(final QualifiedName qualifiedName, final NameEnvironmentAnswer answer) {
