 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.generator.parser.antlr.debug.simpleAntlr.impl.GroupImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupImpl extends RuleElementImpl implements Group
{
  /**
  ...
  {
    return SimpleAntlrPackage.Literals.GROUP;
  }
  ...
  public EList<RuleElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<RuleElement>(RuleElement.class, this, SimpleAntlrPackage.GROUP__ELEMENTS);
    }
    return elements;
  }
