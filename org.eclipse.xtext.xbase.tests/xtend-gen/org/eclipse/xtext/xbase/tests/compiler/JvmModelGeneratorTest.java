...
public class JvmModelGeneratorTest extends AbstractXbaseTestCase {
  ...
  public void testBug380754() {
    try {
      final XExpression expression = this.expression("null");
      @Extension
      final JvmAnnotationReferenceBuilder arefBuilder = this.annotationRefBuilderFactory.create(expression.eResource().getResourceSet());
      final Procedure1<JvmGenericType> _function = (JvmGenericType it) -> {
        EList<JvmMember> _members = it.getMembers();
        final Procedure1<JvmOperation> _function_1 = (JvmOperation it_1) -> {
          this.builder.setBody(it_1, expression);
          final JvmAnnotationReference annotation = arefBuilder.annotationRef(TestAnnotations.class);
          ...
          JvmAnnotationReference _annotationRef = arefBuilder.annotationRef(TestAnnotation.class);
          ...
          JvmAnnotationReference _annotationRef_1 = arefBuilder.annotationRef(TestAnnotation.class);
          ...
          JvmAnnotationReference _annotationRef_2 = arefBuilder.annotationRef(TestAnnotation.class);
    ...
    try {
      ...
      final Procedure1<JvmGenericType> _function = (JvmGenericType it) -> {
        ...
        final Procedure1<JvmOperation> _function_1 = (JvmOperation it_1) -> {
          ...
          JvmAnnotationReference _annotationRef_1 = arefBuilder.annotationRef(TestAnnotation2.class);
